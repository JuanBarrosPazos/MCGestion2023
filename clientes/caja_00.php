...
if(($_SESSION['Nivel'] == 'admin') || ($_SESSION['Nivel'] == 'userpro')){$h = 'height=620px';}
else {$h = 'height=250px';}
...
elseif(($_SESSION['nclient'] == 'admin') || ($_SESSION['nclient'] == 'userpro') || ($_SESSION['nclient'] == 'user') || ($_SESSION['nclient'] == 'caja')){
$dtcl =  "SELECT * FROM `admin` WHERE `ref` = '$refclient' ORDER BY `Nombre` ASC ";
$qdtcl = mysqli_query($db, $dtcl);}

	while($rowdtcl = mysqli_fetch_assoc($qdtcl)){

if (($rowdtcl['Nivel'] == 'admin') || ($rowdtcl['Nivel'] == 'userpro') || ($rowdtcl['Nivel'] == 'user') || ($rowdtcl['Nivel'] == 'caja')){$ruta = '../Admin/img_admin/';}
...
for($i=0; $i<$rowcvnt; $i++){
	...
	$seccx = "`".$seccx."`";
	$tablapro = "pro".$rowvnt['vseccion'];
	$tablapro = "`".$tablapro."`";
	$tablastock = "stock".$rowvnt['vseccion'];
	$tablastock = "`".$tablastock."`";
	$refpro = $rowvnt['producto']; 

	$cs1 = "SELECT * FROM $tablastock WHERE `producto` = '$rowvnt[producto]' AND `kgdifer` > 0 ";
...
/* SUMA AL STOCK LA EL CARRO CANCELADO */
	...
	$vnt = "UPDATE `$db_name`.$tablastock SET `kgcash` = '$cuadrastock', `kgdifer` = '$cuadrastock1', `pvptot` = '$cuadrapvptot', `coment` = '$coment' WHERE $tablastock.`producto` = '$rowvnt[producto]' AND `kgdifer` > 0  LIMIT 1 ";

	if(mysqli_query($db, $vnt)){
print( "* ACTUALIZADO STOCK ".$seccx." / ".$tablastock."</br>" );
global $textcarro;
$textcarro = "\n* FCANCEL 1 ACTUALIZADO STOCK ".$seccx." ".$tablastock.".";
					} else {
...
for($i=0; $i<$rowcvnt; $i++){
	...
	$cs1 = "SELECT * FROM $tablapro WHERE `valor` = '$rowvnt[producto]'  LIMIT 1 ";
	$qcs1 = mysqli_query($db, $cs1);
	$rowcs1 = mysqli_fetch_assoc($qcs1);
...
for($i=0; $i<$rowcvnt; $i++){
	...
	$seccx = $rowvnt['vseccion'];
	$seccx = "`".$seccx."`";
	$tablapro = "feedpro".$rowvnt['vseccion'];
	$tablapro = "`".$tablapro."`";
	$refpro = $rowvnt['producto']; /* ref pro */
...
$vnt = "UPDATE `$db_name`.$tablapro SET  `stock` = '$cuadrastock1' WHERE $tablapro.`valor` = '$refpro' LIMIT 1 ";
	...
	if(mysqli_query($db, $vnt)){
print( "* FCANCEL 3 ACTUALIZADO FEED PRO STOCK ".$seccx." / ".$tablapro."</br>" );
global $textcarro;
$textcarro = "\n* FCANCEL 3 ACTUALIZADO FEED PRO STOCK ".$seccx." ".$tablapro.".";
...
/* RESTA COMPRA A STOCKS */															
	...
	$tablapro = "pro".$_POST['seccion'];
	$tablapro = "`".$tablapro."`";

	$tablastock = "stock".$_POST['seccion'];
	$tablastock = "`".$tablastock."`";
...
print( "* ACTUALIZADO STOCK ".$seccx." ".$tablastock."</br>" );
global $textcarro2;
$textcarro2 = "\n* ACTUALIZADO STOCK RESTADO ".$kgcash."".$seccx." ".$tablastock."";
					} else {
				print("	</br><font color='#FF0000'>* ERROR: </font> ".mysqli_error($db));
									}
...
$secc2 = "pro".$_POST['seccion'];
$sqlc2 = "UPDATE `$db_name`.$secc2 SET  `stock` = '$cuadrastock1' WHERE $secc2.`valor` = '$refpro' LIMIT 1 ";

	if(mysqli_query($db, $sqlc2)){
print( "* ACTUALIZADO PRO STOCK ".$secc2." ".$cuadrastock1."</br>" );
global $textcarro3;
$textcarro3 = "\n* ACTUALIZADO PRO STOCK ".$secc2." ".$cuadrastock1."";
				} else {
				print("<font color='#FF0000'>
						* DATOS NO VALIDOS: </font>".mysqli_error($db))."</br>";
							}
...
$secc3 = "feedpro".$_POST['seccion'];
$sqlc3 = "UPDATE `$db_name`.$secc3 SET `stock` = '$cuadrastock1' WHERE $secc3.`valor` = '$refpro' LIMIT 1 ";

	if(mysqli_query($db, $sqlc3)){
print( "* ACTUALIZADO FEED FEED PRO ".$secc3." ".$cuadrastock1."</br>" );
global $textcarro4;
$textcarro4 = "\n* ACTUALIZADO FEED PRO ".$secc3." ".$cuadrastock1."";
				} else {
				print("<font color='#FF0000'>
						* DATOS NO VALIDOS: </font>".mysqli_error($db))."</br>";
							}
...
/* SUMAN O RESTA COMPRA MODIFICADA A STOCKS */															
	...
	$tablapro = "pro".$_POST['vseccion'];
	$tablapro = "`".$tablapro."`";

	$tablastock = "stock".$_POST['vseccion'];
	$tablastock = "`".$tablastock."`";
...
$secc2 = "pro".$_POST['vseccion'];
$sqlc2 = "UPDATE `$db_name`.$secc2 SET  `stock` = '$cuadrastock1' WHERE $secc2.`valor` = '$refpro' LIMIT 1 ";

	if(mysqli_query($db, $sqlc2)){
print( "* MODIF PRO 2 ACTUALIZADO PRO STOCK ".$_POST['vseccion']." ".$secc2."</br>" );
global $textcarro3;
$textcarro3 = "\t* MODIF PRO 2 ACTUALIZADO PRO STOCK ".$_POST['vseccion']." ".$secc2.".\n";						
				} else {
				print("<font color='#FF0000'>
						* DATOS NO VALIDOS: </font>".mysqli_error($db))."</br>";
							}
...
$secc3 = "feedpro".$_POST['vseccion'];
$sqlc3 = "UPDATE `$db_name`.$secc3 SET `stock` = '$cuadrastock1' WHERE $secc3.`valor` = '$refpro' LIMIT 1 ";

	if(mysqli_query($db, $sqlc3)){
print( "* MODIF PRO 2 ACTUALIZADO FEED PRO STOCK ".$_POST['vseccion']." ".$secc3."</br>" );
global $textcarro4;
$textcarro4 = "\t* MODIF PRO 2 ACTUALIZADO  FEED PRO STOCK ".$_POST['vseccion']." ".$secc2.".\n";						
...
/* SUMA AL STOCK AL CARRO CANCELADO */
	...
	if(mysqli_query($db, $cs2)){
print( "* ELIM PRO 2 ACTUALIZADO STOCK ".$seccx." ".$tablastock." ".$cuadrastock1."</br>" );
global $textcarro2;
$textcarro2 = "\t* ELIM PRO 2 ACTUALIZADO STOCK ".$seccx." ".$tablastock.".\n";
					} else {
				print("	</br><font color='#FF0000'>* ERROR: </font> ".mysqli_error($db));
									}
...
$sqlc2 = "UPDATE `$db_name`.$secc2 SET  `stock` = '$cuadrastock1' WHERE $secc2.`valor` = '$refpro' LIMIT 1 ";
	...
	if(mysqli_query($db, $sqlc2)){
print( "* ELIM PRO 2 ACTUALIZADO PRO STOCK ".$secc2." ".$cuadrastock1."</br>" );
global $textcarro3;
$textcarro3 = "\t* ELIM PRO 2 ACTUALIZADO PRO STOCK ".$secc2." ".$cuadrastock1.".\n";
				} else {
				print("<font color='#FF0000'>
						* DATOS NO VALIDOS: </font>".mysqli_error($db))."</br>";
							}
...
$sqlc3 = "UPDATE `$db_name`.$secc3 SET `stock` = '$cuadrastock1' WHERE $secc3.`valor` = '$refpro' LIMIT 1 ";
	...
	if(mysqli_query($db, $sqlc3)){
print( "* ELIM PRO 2 ACTUALIZADO FEED PRO STOCK ".$secc3." ".$cuadrastock1."</br>" );
global $textcarro4;
$textcarro4 = "\t* ELIM PRO 2 ACTUALIZADO FEED PRO STOCK ".$secc3." ".$cuadrastock1.".\n";
				} else {
				print("<font color='#FF0000'>
						* DATOS NO VALIDOS: </font>".mysqli_error($db))."</br>";
							}
