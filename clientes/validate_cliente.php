...
////////////////////				////////////////////				////////////////////
	...
	/* COMPROBAMOS SI EXISTE EL ADMINISTRADOR */
		...
		$admin =  "SELECT * FROM `$db_name`.$gst_clientes WHERE `ref` = '$rf'";
...
////////////////////				////////////////////				////////////////////
	...
	$sqldni =  "SELECT * FROM `$db_name`.$gst_clientes WHERE $gst_clientes.`dni` = '$_POST[dni]'";
...
////////////////////				////////////////////				////////////////////
	...
	if(strlen(trim($_POST['Nivel'])) == 0){
		$errors [] = "NIVEL: CAMPO OBLIGATORIO";
		}
	...
	$sqlml =  "SELECT * FROM `$db_name`.$gst_clientes WHERE $gst_clientes.`Email` = '$_POST[Email]'";
...
////////////////////				////////////////////				////////////////////
	...
	$sqlus =  "SELECT * FROM `$db_name`.$gst_clientes WHERE $gst_clientes.`Usuario` = '$_POST[Usuario]'";
...
////////////////////				////////////////////				////////////////////
	...
	$sqltlf1 =  "SELECT * FROM `$db_name`.$gst_clientes WHERE $gst_clientes.`Tlf1` = '$_POST[Tlf1]' OR $gst_clientes.`Tlf2` = '$_POST[Tlf1]' ";
...
////////////////////				////////////////////				////////////////////
	...
	if(strlen(trim($_POST['Tlf2'])) > 0){
			...
			$sqltlf2 =  "SELECT * FROM `$db_name`.$gst_clientes WHERE $gst_clientes.`Tlf1` = '$_POST[Tlf2]' OR $gst_clientes.`Tlf2` = '$_POST[Tlf2]'";
