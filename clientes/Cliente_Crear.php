...
/**************************************/
	...
	$tabla = "<table align='center' style='margin-top:10px'>
		...
		<img src='../Admin_clientes/img_cliente/".$safe_filename."' height='120px' width='90px' />
					</td>
				</tr>
				...
				<tr>
					<th colspan=3 valign=\"bottom\" class='BorderSup'>
						<a href='../index.php'>
							ACCEDA AL SISTEMA COMO CLIENTE
						</a>
					</th>
				</tr>
...
"<font color='#FF0000'>**</font> El archivo ".$nombre." ya existe, seleccione otra imagen.</br>"
	...
	if(mysqli_query($db, $sql)){
				...
				* MODIFIQUE LA ENTRADA: </font></br> ".mysqli_error($db))."
					...
					print("NO SE HA PODIDO GUARDAR EN ../Admin_clientes/img_cliente/");
			}
