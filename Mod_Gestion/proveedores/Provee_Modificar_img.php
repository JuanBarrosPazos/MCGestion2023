...
function process_form(){
	...
	$sqla = "UPDATE `$db_name`.$proveedores SET `myimg` = '$new_name'  WHERE $proveedores.`id` = '$id' LIMIT 1 ";
		
	$sqlax = "UPDATE `$db_name`.$proveedoresfeed SET `myimg` = '$new_name'  WHERE $proveedoresfeed.`dni` = '$dinold' LIMIT 1 ";
