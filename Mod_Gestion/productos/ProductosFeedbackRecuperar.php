...
function process_form(){
	...
	if($CountSelectProductos == 0){
		...
		$SqlInsertProductos = "INSERT INTO `$db_name`.$Productos (`vseccion`, `valor`, `nombre`, `ref`, `psiva`, `iva`, `ivae`, `pvp`, `kgin`, `datekgin`, `nsemana`, `kgbad`, `datekgbad`, `kgcash`, `pvptot`, `datecash`, `stock`, `myimg1`, `myimg2`, `myimg3`, `myimg4`, `coment`) VALUES ('$RowSelectProductosFeed[vseccion]','$RowSelectProductosFeed[valor]','$RowSelectProductosFeed[nombre]','$RowSelectProductosFeed[ref]','$RowSelectProductosFeed[psiva]','$RowSelectProductosFeed[iva]','$RowSelectProductosFeed[ivae]','$RowSelectProductosFeed[pvp]','$RowSelectProductosFeed[kgin]','$RowSelectProductosFeed[datekgin]','$RowSelectProductosFeed[nsemana]','$RowSelectProductosFeed[kgbad]','$RowSelectProductosFeed[datekgbad]','$RowSelectProductosFeed[kgcash]','$RowSelectProductosFeed[pvptot]','$RowSelectProductosFeed[datecash]','$RowSelectProductosFeed[stock]','$RowSelectProductosFeed[myimg1]','$RowSelectProductosFeed[myimg2]','$RowSelectProductosFeed[myimg3]','$RowSelectProductosFeed[myimg4]','$RowSelectProductosFeed[coment]')";		
