...
function process_form(){
	...
	$sqla = "INSERT INTO `$db_name`.$secc1 (`producto`,`proname`, `myimg1`, `myimg2`, `myimg3`, `myimg4`) VALUES ('$_POST[valor]', '$_POST[nombre]', '$new_name1', '$new_name2', '$new_name3', '$new_name4')";
	...
	$sqld =  "SELECT * FROM `$db_name`.$seccx2 WHERE `valor` = '$_POST[valor]'";
	$qd = mysqli_query($db, $sqld);
	global $conutc;
	...
	$sql = "INSERT INTO `$db_name`.$secc (`valor`, `nombre`, `ref`, `coment`) VALUES ('$_POST[valor]', '$_POST[nombre]', '$_POST[ref]', '$_POST[coment]')";
	...
	require "../config/TablesNames.php";
	$sqlf =  "SELECT * FROM `$db_name`.$tablafeedpro2 WHERE `valor` = '$_POST[valor]'";
	...
	if(mysqli_query($db, $sql)){ print("");
		} else { print("</br><font color='#FF0000'>* </font></br> ".mysqli_error($db))."</br>";
					}
			}
	}	/* Final process_form(); */
