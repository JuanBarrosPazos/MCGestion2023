...
function process_form(){
	...
	$sqlb = "SELECT * FROM $feedtable WHERE `producto` LIKE '$fil' AND $camp2 LIKE '$fil2' ORDER BY $orden";
...
/////////////////////////
	...
	require "../config/TablesNames.php";
	$sqlp =  "SELECT * FROM $tablafeedpro ORDER BY `valor` ASC ";
...
function accion_data_ver(){
	...
	if (($_SESSION['Nivel'] == 'admin') || ($_SESSION['Nivel'] == 'plus')){ $dir = 'Admin';}
		...
		global $text;
		$text = "- STOCK FEEDBACK VER ".$ActionTime.". ".$feedtable.$pro.$value;
