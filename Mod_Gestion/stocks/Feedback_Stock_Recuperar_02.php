...
function process_form(){
	...
	$tabla = "<table align='center' style=\"margin-top:20px\">
				<tr>
					<th colspan=2  class='BorderInf'>DATOS RECUPERADOS.</th>
				</tr>
				<tr>
					<td>WEEK</td>
					<td>".$_POST['nsemana']."</td>
	...
	$sqlx = "DELETE FROM `$db_name`.$feedtable WHERE $feedtable.`id` = '$_POST[id]' LIMIT 1  ";

	if(mysqli_query($db, $sqlx)){ global $texf;
								  $texf = "\n\t DATOS RECUPERADOS EN ".$tablastock3.".";
								  $texf = $texf."\n\t SE HA BORRADO EL RESPALDO ".$feedtable.".";
		} else {
		print("<font color='#FF0000'>
...
global $text;
$text = "- STOCK FEEDBACK RECUPERAR 2 ".$ActionTime.". ".$tablastock3.".\n\t DATE IN:".$_POST['nsemana']."/".$_POST['datekgin'].".\n\t Pro Ref: ".$_POST['producto'].".\n\t Pro Name: ".$_POST['proname'];
