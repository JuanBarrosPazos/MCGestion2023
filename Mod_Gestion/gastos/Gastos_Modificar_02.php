...
function process_form(){
	...
	$sqla = "UPDATE `$db_name`.$gastos  SET `factnum` = '$_POST[factnum]', `factdate` = '$factdate', `factnom` =  '$_POST[factnom]', `factnif` = '$_POST[factnif]', `factiva` = '$_POST[factiva]', `factivae` = '$factivae', `factpvp` = '$factpvp',  `factpvptot` = '$factpvptot', `coment` = '$_POST[coment]' WHERE $gastos.`id` = '$_POST[id]'  ";
