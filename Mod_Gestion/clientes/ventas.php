...
function process_form(){
	...
	$sqlc =  "SELECT * FROM $ventas WHERE `refclient` = '$rf' AND `oper` = '$rop' AND  `datecash` LIKE '$fil' ORDER BY $orden ";
...
function ver_todo(){
	...
	require "../config/TablesNames.php";
	$sqlb =  "SELECT * FROM $ventas WHERE `refclient` = '$rf' AND `datecash` LIKE '$fil' ORDER BY $orden ";
