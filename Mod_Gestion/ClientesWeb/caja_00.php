...
function pago2($errors=[]){
	...
	global $ClientRef;		$ClientRef = $RowSqlCajaShopOper1['refclient'];
		...
		if($ClientRef == ''){ 
			print("<table align='center'>
					<tr>
						<td class='BorderInf'>
					<font style='color:#F1BD2D;' >HA DE SELECCIONAR UN CLIENTE</font>
						</td>
					</tr>
					<tr>
						<td align='center'>
	...
	if($ClientRef != ''){ 
		print("<table align='center'>
				<tr>
					<td align='center' colspan='6' class='BorderInf'>
						<font style='color:#F1BD2D;' >FORMA DE PAGO</font>
					</td>
				</tr>
				<tr>
					<td align='center'>
...
function selec_client(){
	...
	if(!$qb){ print("* ERROR SQL L.914/918 ".mysqli_error($db)."</br>");
				...
				print("<table align='center' style=\"border:0px\">
							<tr>
								<td align='center'><font style='color:#F1BD2D;' >NO HAY DATOS</font></td>
							</tr>
						</table>");
...
function ver_todocl(){
	...
	if(!$qb){ print("* ERROR SQL L.1032/1036 ".mysqli_error($db)."</br>");
			...
			print ("<table align='center'>
					<tr>
						<td><font style='color:#F1BD2D;' >NO HAY DATOS</font></td>
					</tr>
				</table>");
		}else{ require 'TablaSelectCliente.php'; } // FIN ELSE
					...
					<tr align='center'>
						<td>
							<font style='color:#F1BD2D;' ><b>SELECCIONE UN PRODUCTO</font>
								<br>
							<font style='color:#F1BD2D;' b>NO HAY DATOS</font>
						</td>
					</tr>
				</table>");
			...
			<option value=''>PRODUCTOS</option>");
				...
				$qp = mysqli_query($db, $sqlp);
					...
					print ("</select></form></td></tr></table>");
						...
						print("<table align='center' style='margin:-0.6em auto 0.8em auto;'>
							<tr align='center'>
								<td><font style='color:#F1BD2D;' ><b>SELECCIONE UNA SECCION</font></td>
							</tr>
						</table>");
