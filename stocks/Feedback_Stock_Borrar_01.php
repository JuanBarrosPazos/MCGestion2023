...
function process_form(){
	...
	$sqlc =  "SELECT * FROM $feedtable WHERE `producto` LIKE '$fil' AND $camp2 LIKE '$fil2' ORDER BY $orden";
	...
	if ($rowc['producto'] == ''){
			...
			print (	"<tr align='center'>
				...
				<form name='modifica' action='Feedback_Stock_Borrar_02.php' method='POST'>
...
$dm = array (	'' => 'MES',
	...
	require "../config/TablesNames.php";
	$sqlp =  "SELECT * FROM $tablafeedpro2 ORDER BY `valor` ASC ";
...
function accion_Borrar_01(){
	...
	if ($_SESSION['Nivel'] == 'admin'){ $dir = 'Admin';}
		...
		global $text;
		$text = "- STOCK FEEDBACK BORRAR 1 ".$ActionTime.". ".$secc.$pro.$value;
