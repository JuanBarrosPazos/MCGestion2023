...
if (($_SESSION['Nivel'] == 'admin') || ($_SESSION['Nivel'] == 'userpro') || ($_SESSION['Nivel'] == 'user')){
...
function process_form(){
	...
	$sqlp2 =  "SELECT * FROM `$producto` WHERE `valor` = '$_POST[producto]' ";
	...
	$sql = "INSERT INTO `$db_name`.$secc ( `nsemana`,`producto`, `proname`, `psiva`, `iva`, `ivae`, `pvp`, `kgin`, `datekgin`, `kgbad`, `datekgbad`, `kgcash`, `pvptot`, `datecash`, `kgdifer`, `coment`) VALUES ( '$semana', '$_POST[producto]', '$proname', '$psiva', '$_POST[iva]', '$ivae', '$pvp', '$kgin',  '$date',  '$kgbad', '$_POST[datekgbad]', '$kgcash', '$pvptot', '$date', '$diferencia', '$_POST[coment]')";
...
$sqlc2 = "UPDATE `$db_name`.$secc2 SET `psiva` = '$psiva', `iva` = '$_POST[iva]', `ivae` = '$ivae', `pvp` = '$pvp', `stock` = '$diferencia' WHERE $secc2.`valor` = '$_POST[producto]' LIMIT 1 ";
...
$sqlc3 = "UPDATE `$db_name`.$secc3 SET `psiva` = '$psiva', `iva` = '$_POST[iva]', `ivae` = '$ivae', `pvp` = '$pvp', `stock` = '$diferencia' WHERE $secc3.`valor` = '$_POST[producto]' LIMIT 1 ";
...
/////////////////// RESTA AL STOCK LA NUEVA ENTRADA //////////
	...
	$cs2 = "UPDATE `$db_name`.$tablastock SET `kgin` = '$cuadrastock', `kgdifer` = '$cuadrastock1', `coment` = '$coment' WHERE $tablastock.`id` = '$rowcs1[id]' LIMIT 1 ";
...
$secc2 = "pro".$_POST['seccion'];
$sqlc2 = "UPDATE `$db_name`.$secc2 SET `psiva` = $rowcs4[psiva], `iva` = $rowcs4[iva], `ivae` = $rowcs4[ivae], `pvp` = '$pvp', `stock` = '$cuadrastock3' WHERE $secc2.`valor` = '$_POST[producto]' LIMIT 1 ";
...
$secc3 = "feedpro".$_POST['seccion'];
$sqlc3 = "UPDATE `$db_name`.$secc3 SET `psiva` = $rowcs4[psiva], `iva` = $rowcs4[iva], `ivae` = $rowcs4[ivae], `pvp` = '$pvp', `stock` = '$cuadrastock3' WHERE $secc3.`valor` = '$_POST[producto]' LIMIT 1 ";
