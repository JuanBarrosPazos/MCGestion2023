...
$sqlc = "UPDATE `$db_name`.$secc SET `nsemana` = '$_POST[nsemana]', `producto` = '$_POST[producto]', `proname` = '$proname', `psiva` = '$psiva', `iva` = '$_POST[iva]', `ivae` = '$ivae', `pvp` = '$pvp', `kgin` = '$kgin', `datekgin` = '$_POST[datekgin]', `kgbad` = '$kgbad', `datekgbad` = '$_POST[datekgbad]', `kgcash` = '$kgcash', `pvptot` = '$pvptot', `datecash` = '$date', `kgdifer` = '$diferencia', `coment` = '$_POST[coment]' WHERE $secc.`id` = '$_POST[id]' LIMIT 1 ";
