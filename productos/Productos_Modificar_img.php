...
function modifica_form(){
		...
		$secc2 = "imgpro".$_SESSION['miseccion'];
		$secc2 = "`".$secc2."`";
...
function process_form(){
	...
	$_SESSION['miref'] = $_POST['ref'];
		...
		$secc1 = "imgpro".$_SESSION['miseccion'];
		$secc1 = "`".$secc1."`";
	...
	$_SESSION['myimg4'] = $rowsc['myimg4'];
				...
				$sqlc =  "SELECT * FROM `$db_name`.$secc1 WHERE `producto` = '$valor'";
				$qc = mysqli_query($db, $sqlc);
				$countc = mysqli_num_rows($qc);
				$rowsc = mysqli_fetch_assoc($qc);
...
$printimg =	"<div id='foto1A' class='img2'> 
	...
	<!-- Inicio footer -->
	<div id='footer' style=".$style.">&copy; Juan Barr&oacute;s Pazos 2001.</div>
	<!-- Fin footer -->
	</div>
