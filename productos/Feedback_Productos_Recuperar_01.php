...
function process_form(){
	...
	elseif($rowc['valor'] != ''){	
			...
			print (	"<tr align='center'>
				...
				<form name='modifica' action='Feedback_Productos_Recuperar_02.php' method='POST'>
	...
	$producto = "feedpro".$_POST['seccion'];
		...
		print("
			...
			<form name='form_tabla' method='post' action='$_SERVER[PHP_SELF]'>
				<tr>
					<th colspan='4'>
						RECUPERAR FEED PRODUCTOS ".$rowseccion['nombre']."
					</th>
				</tr>		
				<tr>
					<td align='right'>
...
function accion_modifica_01(){
	...
	elseif (($_SESSION['Nivel'] == 'user') || ($_SESSION['Nivel'] == 'caja')){ $dir = 'User';}
		...
		$logdate = date('Y_m_d');
		$logtext = "- PRODUCTOS FEEDBACK RECUPERAR 1: ".$ActionTime.". ".$tablafeedpro2."\n";
