...
function process_form(){
	...
	$sql = "INSERT INTO `$db_name`.$secc (`valor`, `nombre`, `ref`, `coment`, `borrado`) VALUES ('$_POST[valor]', '$_POST[nombre]', '$_POST[ref]', '$_POST[coment]', '$FBaja')";
...
global $text;
$text = "- PRODUCTOS FEEDBACK CREAR ".$ActionTime.". ".$secc.", ".$_POST['nombre'].", ".$_POST['valor'].", ".$_POST['ref'].", ".$_POST['coment'];
