...
function admin_entrada(){
	...
	$sqladin = "UPDATE `$db_name`.$gst_admin SET `lastin` = '$datein', `visitadmin` = '$total' WHERE $gst_admin .`id` = '$userid' LIMIT 1 ";
...
function show_visit(){
	...
	$sqlv =  "SELECT * FROM $gst_visitasadmin ";
...
function suma_visit(){
	...
	$sqlv = "UPDATE `$db_name`.$gst_visitasadmin SET `admin` = '$sumavisit' WHERE $gst_visitasadmin.`idv` = '$idv' LIMIT 1 ";
...
function suma_acces(){
	...
	$sqla =  "SELECT * FROM $gst_visitasadmin";
	...
	$sqla = "UPDATE `$db_name`.$gst_visitasadmin SET `acceso` = '$sumaacces' WHERE $gst_visitasadmin.`idv` = '$idv' LIMIT 1 ";
...
function suma_denegado(){
	...
	$sqld =  "SELECT * FROM $gst_visitasadmin";
	...
	$sqld = "UPDATE `$db_name`.$gst_visitasadmin SET `deneg` = '$sumadeneg' WHERE $gst_visitasadmin.`idv` = '$idd' LIMIT 1 ";
...
function recup_compra(){
	...
	$rc =  "SELECT * FROM $gst_caja WHERE `ini` > '0' ";
