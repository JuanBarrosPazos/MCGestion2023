<?php
	...
	print("<table align='center' border=0>
				...
				<th colspan=3 width=100% class='BorderInf'>
					<form name='boton' action='Admin_Ver.php' method='post' style='display: inline-block;' >
							<input type='submit' value='INICIO ADMIN' />
							<input type='hidden' name='volver' value=1 />
					</form>
					<form name='boton' action='Feedback_Ver.php' method='post' ".$estilo." >
