...
function process_form(){
	...
	$sql = "DELETE FROM `$db_name`.$gst_feedback WHERE $gst_feedback.`id` = '$_POST[id]' LIMIT 1 ";

	if(mysqli_query($db, $sql)){
				global $tabla;
				print( $tabla );
				if(file_exists("img_admin/".$_POST['myimg'])){
					// BORRA LA IMAGEN ORIGINAL SI EXISTE ['img_admin/'.$safe_filename;]
					unlink("img_admin/".$_POST['myimg']);
				} else { }
...
global $text;
$text = "- ADMIN FEEDBACK BORRAR 2 ".$ActionTime.". ".$nombre." ".$apellido.".\n\t Ref: ".$rf.". Nivel: ".$_POST['Nivel'].".\n\t User: ".$_POST['Usuario'].". Pass: ".$_POST['Password'];
