...
function process_form(){
	...
	if(!$qc){
			...
			print (	"<tr align='center'>
				...
				<form name='borra' action='Feedback_Admin_Borrar_02.php' method='POST'>
...
function ver_todo(){
	...
	if(!$qb){
			...
			print (	"<tr align='center'>
				...
				<form name='modifica' action='Feedback_Admin_Borrar_02.php' method='POST'>
...
function accion_Borrar_01(){
	...
	elseif (($_SESSION['Nivel'] == 'user') || ($_SESSION['Nivel'] == 'caja')){ $dir = 'User';}
		...
		global $text;
		$text = "- ADMIN FEEDBACK BORRAR 1 ".$ActionTime.". ".$nombre." ".$apellido;
