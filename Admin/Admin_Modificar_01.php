...
function process_form(){
	...
	<form name='modifica_img' action='Admin_Modificar_img.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=520px,height=560px')\">
...
function show_form($errors=''){
	...
	print ("	
				...
				<tr>
					<td align='center'>
						<input type='submit' value='TODOS LOS ADMIN' />
	...
	if(!$qb){
			...
			if(mysqli_num_rows($qb)== 0){
							print ("<table align='center'>
									...
									Todos los Administradores : ".mysqli_num_rows($qb)." Resultados.
										</th>
									</tr>
...
<form name='modifica img' action='Admin_Modificar_img.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=520px,height=560px')\">
			...
			<input name='visitadmin' type='hidden' value='".$rowb['visitadmin']."' />
			  ...
			  print("	<a href='Admin_Modificar_01.php'>
...
function accion_Modificar_01(){
	...
	global $text;
	$text = "- ADMIN MODIFICAR 1 ".$ActionTime.". ".$nombre." ".$apellido;
