...
function process_form(){
	...
	$sqlc = "UPDATE `$db_name`.$gst_admin SET `Nivel` = '$_POST[Nivel]', `Nombre` = '$_POST[Nombre]', `Apellidos` = '$_POST[Apellidos]', `doc` = '$_POST[doc]', `dni` = '$_POST[dni]', `ldni` = '$_POST[ldni]', `Email` = '$_POST[Email]', `Usuario` = '$_POST[Usuario]', `Password` = '$_POST[Password]', `Direccion` = '$_POST[Direccion]', `Tlf1` = '$_POST[Tlf1]', `Tlf2` = '$_POST[Tlf2]' WHERE $gst_admin.`id` = '$_POST[id]' LIMIT 1 ";
	...
	$sqlcl = "UPDATE `$db_name`.$gst_caja SET `refclient` = '$rf' WHERE $gst_caja.`refclient` = '$srefcl' ";
