<?php
	...
	if($KeyFeedback == 1){
		$accion = "Admin_Ver.php";
		$valor = "GESTION DE ADMINISTRADORES";
		$BotonFeed = "";
	} else {
		$accion = "Admin_Crear.php";
		$valor = "CREAR ADMINISTRADOR";
		$BotonFeed = "<form name='boton' action='Feedback_Ver.php' method='post' style='display: inline-block;' >
