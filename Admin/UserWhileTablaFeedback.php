<?php
		...
		if($KeyRecuperaFeedback == 1){
			$accion = "Feedback_Admin_Recuperar_02.php";
			$valor = "RECUPERAR DATOS FEEDBACK";
            $PopUp = "";
		 } elseif ($KeyBorraFeedback == 1){ 
			$accion = "Feedback_Admin_Borrar_02.php";
			$valor = "BORRAR DATOS FEECBACK";
            $PopUp = "";
		} else { $accion = "Feedback_Ver_02.php";
			     $valor = "VER DETALLES";
		...
		print (	"<tr align='center'>
				...
				<form name='ver' action='Feedback_Ver_02.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=500px,height=610px')\" style='display: inline-block;'>
				...
				<form name='modifica' action='Feedback_Admin_Recuperar_02.php' method='POST' style='display: inline-block;'>
						<input name='id' type='hidden' value='".$rowb['id']."' />
						<input name='ref' type='hidden' value='".$rowb['ref']."' />
						<input name='Nivel' type='hidden' value='".$rowb['Nivel']."' />
						<input name='Nombre' type='hidden' value='".$rowb['Nombre']."' />
				...
				<form name='modifica' action='Feedback_Admin_Borrar_02.php' method='POST' style='display: inline-block;'>
						<input name='id' type='hidden' value='".$rowb['id']."' />
						<input name='ref' type='hidden' value='".$rowb['ref']."' />
						<input name='Nivel' type='hidden' value='".$rowb['Nivel']."' />
						<input name='Nombre' type='hidden' value='".$rowb['Nombre']."' />
