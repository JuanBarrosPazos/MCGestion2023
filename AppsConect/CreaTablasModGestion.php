...
$clientes = "CREATE TABLE `$db_name`.$table_name_cl (
...
$table_name_fcl = "`".$_SESSION['clave']."gst_clientesfeedback`";

$feedbackcl = "CREATE TABLE `$db_name`.$table_name_fcl (
`id` int(4) NOT NULL auto_increment,
`ref` varchar(20) collate utf8_spanish2_ci NOT NULL,
`Nivel` varchar(8) collate utf8_spanish2_ci NOT NULL default 'cliente',
`Nombre` varchar(25) collate utf8_spanish2_ci NOT NULL,
...
$table_name_ntb = "`".$_SESSION['clave']."gst_nametables`";

$nametables = "CREATE TABLE `$db_name`.$table_name_ntb (
...
$table_name_gfstf = "`".$_SESSION['clave']."gst_globalfeedstockf`";

$gfstf = "CREATE TABLE `$db_name`.$table_name_gfstf (
`id` int(4) NOT NULL auto_increment,
`vseccion` varchar(22) collate utf8_spanish2_ci NOT NULL,
`nsemana` int(2) NOT NULL,
...
$table_name_gcj = "`".$_SESSION['clave']."gst_caja`";

$gcj = "CREATE TABLE `$db_name`.$table_name_gcj (
`id` int(4) NOT NULL auto_increment,
...
$table_name_prv = "`".$_SESSION['clave']."gst_proveedores`";

$provee = "CREATE TABLE `$db_name`.$table_name_prv (
`id` int(4) NOT NULL auto_increment,
`ref` varchar(20) collate utf8_spanish2_ci NOT NULL,
...
$table_name_prvf = "`".$_SESSION['clave']."gst_proveedoresfeed`";

$proveefeed = "CREATE TABLE `$db_name`.$table_name_prvf (
`id` int(4) NOT NULL auto_increment,
`ref` varchar(20) collate utf8_spanish2_ci NOT NULL,
`rsocial` varchar(30) collate utf8_spanish2_ci NOT NULL,
`myimg` varchar(30) collate utf8_spanish2_ci NOT NULL default 'untitled.png ',
...
$vname2 = "../Mod_Gestion/docgastos_".date('Y');
...
$vname3 = "../Mod_Gestion/docgastos_".(date('Y')-1);
