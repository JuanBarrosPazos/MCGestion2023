...
$sqlc =  "SELECT * FROM $vname WHERE `refclient` = '$rfc' AND  `datecash` LIKE '$fil' OR `oper` = '$rop' AND  `datecash` LIKE '$fil' OR `clname` LIKE '$nom' AND  `datecash` LIKE '$fil' ORDER BY $orden ";
...
function ver_todo(){
	...
	$sqlb =  "SELECT * FROM $vname WHERE `datecash` LIKE '$fil' ORDER BY $orden ";
