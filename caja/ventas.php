...
function process_form(){
	...
	$sqlc =  "SELECT * FROM $gst_ventas WHERE `refclient` = '$rfc' AND  `datecash` LIKE '$fil' OR `oper` = '$rop' AND  `datecash` LIKE '$fil' OR `clname` LIKE '$nom' AND  `datecash` LIKE '$fil' ORDER BY $orden ";
...
function ver_todo(){
	...
	require "../config/TablesNames.php";
	$sqlb =  "SELECT * FROM $gst_ventas WHERE `datecash` LIKE '$fil' ORDER BY $orden ";
