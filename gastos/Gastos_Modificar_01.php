...
$sqlc =  "SELECT * FROM $vname WHERE `factnum` = '$fnum' AND `factdate` LIKE '$fil' OR `factnif` = '$fnif' AND  `factdate` LIKE '$fil' OR `factnom` LIKE '$fnom' AND  `factdate` LIKE '$fil' ORDER BY $orden ";
