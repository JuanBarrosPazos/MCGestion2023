...
function process_form(){
	...
	$sqla = "UPDATE `$db_name`.$gst_gastos  SET `factnum` = '$_POST[factnum]', `factdate` = '$factdate', `factnom` =  '$_POST[factnom]', `factnif` = '$_POST[factnif]', `factiva` = '$_POST[factiva]', `factivae` = '$factivae', `factpvp` = '$factpvp',  `factpvptot` = '$factpvptot', `coment` = '$_POST[coment]' WHERE $gst_gastos.`id` = '$_POST[id]'  ";
...
function show_form($errors=[]){
	...
	require "../config/TablesNames.php";
	$sqlx =  "SELECT * FROM $gst_proveedoresfeed WHERE `ref` = '$_POST[proveedores]'";
	...
	if($_POST['oculto2']){
		...
		require "../config/TablesNames.php";
		$sx =  "SELECT * FROM $gst_proveedoresfeed WHERE `dni` LIKE '$fil1' LIMIT 1 ";
...
<input name='id' type='hidden' value='".$defaults['id']."' />
	...
	require "../config/TablesNames.php";
	$sqlb =  "SELECT * FROM $gst_proveedoresfeed ORDER BY `rsocial` ASC ";
