...
function process_form(){
	...
	$sqla = "INSERT INTO `$db_name`.$vname (`factnum`, `factdate`, `factnom`, `factnif`, `factiva`, `factivae`, `factpvp`, `factpvptot`,`coment`, `myimg1`, `myimg2`, `myimg3`, `myimg4`) VALUES ('$_POST[factnum]', '$factdate', '$_POST[factnom]', '$_POST[factnif]', '$_POST[factiva]', '$factivae', '$factpvp', '$factpvptot', '$_POST[coment]', '$new_name1', '$new_name2', '$new_name3', '$new_name4')";
