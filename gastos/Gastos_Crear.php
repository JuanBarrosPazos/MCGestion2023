...
function process_form(){
	...
	$tabla = "<table align='center' style='margin-top:10px'>
				<tr>
					<th colspan=4 class='BorderInf'>
						SE HA GRABADO EN ".strtoupper($gst_gastos)."
					</th>
				</tr>
				<tr>
					<td>NUMERO</td>
	...
	require "../config/TablesNames.php";
	$sqlc =  "SELECT * FROM `$db_name`.$gst_gastos WHERE `factnum` = '$_POST[factnum]'";
	...
	$sqla = "INSERT INTO `$db_name`.$gst_gastos (`factnum`, `factdate`, `factnom`, `factnif`, `factiva`, `factivae`, `factpvp`, `factpvptot`,`coment`, `myimg1`, `myimg2`, `myimg3`, `myimg4`) VALUES ('$_POST[factnum]', '$factdate', '$_POST[factnom]', '$_POST[factnif]', '$_POST[factiva]', '$factivae', '$factpvp', '$factpvptot', '$_POST[coment]', '$new_name1', '$new_name2', '$new_name3', '$new_name4')";
...
function show_form($errors=[]){
	...
	require "../config/TablesNames.php";
	$sqlx =  "SELECT * FROM $gst_proveedores WHERE `ref` = '$_POST[proveedores]'";
	...
	require "../config/TablesNames.php";
	$sqlb =  "SELECT * FROM $gst_proveedores ORDER BY `rsocial` ASC ";
