...
function process_form(){
	...
	if(mysqli_query($db, $sql)){
		...
		if($_FILES['myimg']['size'] == 0){
			...
			global $new_name;
			//$new_name = $rf.".png";
			$rename_filename = "../cb23_Docs/img_proveedores/".$new_name;							
			copy("../cb23_Docs/img_proveedores/untitled.png", $rename_filename);
			...
			$destination_file = "../cb23_Docs/img_proveedores/".$safe_filename;

			if(file_exists( "../cb23_Docs/img_proveedores/".$nombre) ){
					unlink("../cb23_Docs/img_proveedores/".$nombre);
			...
			}else { print("NO SE HA PODIDO GUARDAR EN ../cb23_Docs/img_proveedores/".$new_name);}
	...
	//	print("** ".$rowpimg['myimg']);
		...
		print("<table class='tableForm'>
			...
			<img src='../cb23_Docs/img_proveedores/".$dudas."' height='120px' width='90px' />
					</td>
				</tr>
				<tr>
