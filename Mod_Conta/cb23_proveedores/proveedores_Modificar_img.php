...
function process_form_img(){
	...
	global $destination_file;
		...
		elseif (move_uploaded_file($_FILES['myimg']['tmp_name'], $destination_file)){
			...
			unlink("../cb23_Docs/img_proveedores/".$_SESSION['myimgx']);
			...
			if(mysqli_query($db, $sqla)){
				...
				<img src='../cb23_Docs/img_proveedores/".$new_name."' height='120px' width='90px' />
							</td>
						</tr>
						<tr>
...
function show_form_img($errors=[]){
	...
	print("<table align='center' style='border:none;'>
				...
				<tr>
					...
					<th class='BorderInf'>
		<img src='../cb23_Docs/img_proveedores/".$defaults['myimg']."' height='120px' width='90px' />
					</th>
				</tr>
				<tr>
					<td colspan=2>
