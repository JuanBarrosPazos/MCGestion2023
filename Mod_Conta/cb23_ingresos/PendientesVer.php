...
////////////////////				////////////////////				////////////////////
	...
	function process_form(){
		...
		/*	
		$sqlb =  "SELECT * FROM $vname WHERE (`factnum` = '$fnum' OR `factnif` = '$fnif' OR `refcliente` = '$fnom') AND  (`factdate` LIKE '$fil') ORDER BY $orden ";
		*/
		...
		if(!$qb){
			...
			if(mysqli_num_rows($qb) == 0){
				global $titNoData;		$titNoData = "INGRESOS PENDIENTES ".$dyt1."<br>";
				require 'NoData.php';
			}else{ 
...
////////////////////				////////////////////				////////////////////
	...
	function show_form($errors=[]){
		...
		global $titulo; 		$titulo = "CONSULTAR INGRESOS PENDIENTES";
		global $TitBut1;		$TitBut1 = "VER TODOS LOS INGRESOS";		
		global $TitBut2;		$TitBut2 = "FILTRO BUSQUEDA INGRESOS";
