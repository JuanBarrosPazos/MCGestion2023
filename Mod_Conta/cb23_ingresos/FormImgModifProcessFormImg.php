<?php
		...
		if(isset($_POST['oculto2'])){
			...
			global $vname;		// $vname = "`".$_SESSION['clave']."ingresos_".$_SESSION['midyt1']."`";
			// $vname = $_POST['vname'];	

			global $rutaDir; 		// $rutaDir = "../cb23_Docs/docingresos_".$_SESSION['midyt1']."/";
			...
			$_SESSION['miref'] = $_POST['refcliente'];
