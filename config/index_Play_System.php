...
function admin_entrada(){
	...
	$sqladin = "UPDATE `$db_name`.$gst_clientes SET `lastin` = '$datein', `visitadmin` = '$total' WHERE $gst_clientes.`id` = '$userid' LIMIT 1 ";
...
function suma_visit(){
	...
	$sqlv = "UPDATE `$db_name`.$gst_visitas SET `admin` = '$sumavisit' WHERE $gst_visitas.`idv` = '$idv' LIMIT 1 ";
...
function suma_acces(){
	...
	$sqla = "UPDATE `$db_name`.$gst_visitas SET `acceso` = '$sumaacces' WHERE $gst_visitas.`idv` = '$idv' LIMIT 1 ";
...
function suma_denegado(){
	...
	$sqld = "UPDATE `$db_name`.$gst_visitas SET `deneg` = '$sumadeneg' WHERE $gst_visitas.`idv` = '$idd' LIMIT 1 ";
...
print("WELLCOME ".$_SESSION['Nombre']." ".$_SESSION['Apellidos'].". REF CLIENT: ".$_SESSION['ref']);
	...
	require "config/TablesNames.php";
	$sqlb =  "SELECT * FROM $gst_clientes WHERE `Nombre` = '$nombre' AND `Apellidos` = '$apellido'  ";
