...
////////////////////				////////////////////				////////////////////
	...
	$sqldni =  "SELECT * FROM `$db_name`.$gst_admin WHERE $gst_admin.`dni` = '$_POST[dni]'";
...
////////////////////				////////////////////				////////////////////
	...
	$sqlml =  "SELECT * FROM `$db_name`.$gst_admin WHERE $gst_admin.`Email` = '$_POST[Email]'";
...
////////////////////				////////////////////				////////////////////
	...
	$sqlus =  "SELECT * FROM `$db_name`.$gst_admin WHERE $gst_admin.`Usuario` = '$_POST[Usuario]'";
...
////////////////////				////////////////////				////////////////////
	...
	$sqltlf1 =  "SELECT * FROM `$db_name`.$gst_admin WHERE $gst_admin.`Tlf1` = '$_POST[Tlf1]' OR $gst_admin.`Tlf2` = '$_POST[Tlf1]' ";
...
////////////////////				////////////////////				////////////////////
	...
	if(strlen(trim($_POST['Tlf2'])) > 0){
			...
			$sqltlf2 =  "SELECT * FROM `$db_name`.$gst_admin WHERE $gst_admin.`Tlf1` = '$_POST[Tlf2]' OR $gst_admin.`Tlf2` = '$_POST[Tlf2]'";
