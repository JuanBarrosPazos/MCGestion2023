	...
	$tabla = "<table align='center' style='margin-top:10px'>
				...
				<tr>
					...
					<td rowspan='4' align='center' width='100px'>
						<img src='../Admin/img_admin/".$safe_filename."' height='120px' width='90px' />
					</td>
				</tr>
	      	...
	      	if( file_exists( '../Admin/img_admin/'.$nombre) ){
print("<font color='#FF0000'>**</font> El archivo ".$nombre." ya existe, seleccione otra imagen.</br>"
							);
							show_form();
			}
	...
	$sql = "INSERT INTO `$db_name`.`admin` (`ref`, `Nivel`, `Nombre`, `Apellidos`, `myimg`, `doc`, `dni`, `ldni`, `Email`, `Usuario`, `Password`, `Direccion`, `Tlf1`, `Tlf2`) VALUES ('$rf', '$_POST[Nivel]', '$_POST[Nombre]', '$_POST[Apellidos]', '$safe_filename', '$_POST[doc]', '$_POST[dni]', '$_POST[ldni]', '$_POST[Email]', '$_POST[Usuario]', '$_POST[Password]', '$_POST[Direccion]', '$_POST[Tlf1]', '$_POST[Tlf2]')";
