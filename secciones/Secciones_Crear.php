...
function validate_form(){
	...
	require "../config/TablesNames.php";
	$sqlb =  "SELECT * FROM $gst_secciones WHERE `valor` = '$_POST[valor]' OR `nombre` = '$_POST[nombre]' ";
...
function process_form(){
  ...
  UNIQUE KEY `id` (`id`)
	...
	$sql1c = "INSERT INTO `$db_name`.$gst_nametables (`valortabla`, `nombreseccion`) VALUES ('$StockValor', '$nombre1b')";
  ...
  UNIQUE KEY `id` (`id`)
	...
	$sql2c = "INSERT INTO `$db_name`.$gst_nametables (`valortabla`, `nombreseccion`) VALUES ('$feedtable3', '$name2b')";
  ...
  UNIQUE KEY `id` (`id`)
	...
	$sql3b = "INSERT INTO `$db_name`.$gst_nametables (`valortabla`, `nombreseccion`) VALUES ('$feedtable2b', '$name3b')";
...
/**/
	...
	$sql3b = "INSERT INTO `$db_name`.$gst_nametables (`valortabla`, `nombreseccion`) VALUES ('$feedtable2', '$name4b')";
