...
function validate_form(){
	...
	require "../config/TablesNames.php";
	@$sqlb =  "SELECT * FROM $gst_secciones WHERE (`valor` <> '' AND `id` <> '$_POST[id]') AND (`valor` = '$_POST[valor]' OR `nombre` = '$_POST[nombre]')  ";
	...
	if( mysqli_num_rows($qb) > 0){ 
	 ...
	 /*
	@$sqlc =  "SELECT * FROM $gst_secciones WHERE `id` = '$_POST[id]' AND (`valor` = '$_POST[valor]' OR`nombre` = '$_POST[nombre]')  ";
...
function process_form(){
	...
	$sqlc = "UPDATE `$db_name`.$gst_secciones SET `valor` = '$_POST[valor2]', `nombre` = '$_POST[nombre]' WHERE $gst_secciones.`id` = '$_POST[id]' LIMIT 1 ";
	...
	$sqlntx1 = "UPDATE `$db_name`.$gst_nametables SET `valortabla` = '$tablenewstock', `nombreseccion` = '$nametablestock' WHERE $gst_nametables.`valortabla` LIKE '$filx1' LIMIT 1 ";
	...
	$sqlntx2 = "UPDATE `$db_name`.$gst_nametables SET `valortabla` = '$tablenewpro', `nombreseccion` = '$nametablepro' WHERE $gst_nametables.`valortabla` LIKE '$filx2' LIMIT 1 ";
	...
	$sqlntx3 = "UPDATE `$db_name`.$gst_nametables SET `valortabla` = '$tablenewfeed', `nombreseccion` = '$nametablefeed' WHERE $gst_nametables.`valortabla` LIKE '$filx3' LIMIT 1 ";
...
$tx8 = "  * HA MODIFICADO NOMBRE DE TABLA ".$tableoldfeedpro. " POR ".$tablenewfeedpro."\n";
	...
	$sqlntx4 = "UPDATE `$db_name`.$gst_nametables SET `valortabla` = '$tablenewfeedpro', `nombreseccion` = '$nametablefeedpro' WHERE $gst_nametables.`valortabla` LIKE '$filx4' LIMIT 1 ";
...
/////////////////////////////
	...
	$sqlnt1 = "UPDATE `$db_name`.$gst_nametables SET `valortabla` = '$stock2', `nombreseccion` = '$nametablestock' WHERE $gst_nametables.`valortabla` LIKE '$fil1' LIMIT 1 ";
	...
	$sqlnt2 = "UPDATE `$db_name`.$gst_nametables SET `valortabla` = '$feed2', `nombreseccion` = '$nametablefeed' WHERE $gst_nametables.`valortabla` LIKE '$fil2' LIMIT 1 ";
	...
	$sqlnt3 = "UPDATE `$db_name`.$gst_nametables SET `valortabla` = '$pro2', `nombreseccion` = '$nametablepro' WHERE $gst_nametables.`valortabla` LIKE '$fil3' LIMIT 1 ";
	...
	$sqlnt4 = "UPDATE `$db_name`.$gst_nametables  SET `valortabla` = '$feedpro2', `nombreseccion` = '$nametablepro' WHERE $gst_nametables.`valortabla` LIKE '$fil4' LIMIT 1 ";
