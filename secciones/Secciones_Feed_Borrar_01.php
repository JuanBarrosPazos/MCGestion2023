...
function show_form($errors=[]){
	...
	if ($errors){
		...
		global $FormTitulo;
		$FormTitulo = "BORRAR FEEDBACK SECCION";
...
function ver_todo(){
	...
	$sqlb =  "SELECT * FROM $gst_globalfeedseccion ORDER BY $orden ";
	...
	elseif($rowb['valor'] != '0'){	
			...
			print (	"<tr align='center'>
				...
				<form name='modifica' action='Secciones_Feed_Borrar_02.php' method='POST'>
	...
	<input name='nombre' type='hidden' value='".$rowb['nombre']."' />".$rowb['nombre']."
						...
						<td colspan=2 align='center' class='BorderInf'>
										<input type='submit' value='BORRAR FEEDBACK SECCION' />
...
function accion_Borrar_01(){
	...
	$logdate = date('Y_m_d');
	$logtext = "- SECCION FEED BORRAR 1 ".$ActionTime.". TODAS SIN FILTROS.\n";
