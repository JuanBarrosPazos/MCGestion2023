...
$sqlc =  "SELECT * FROM `clientes` WHERE `Nombre` LIKE '%$nombre%' OR `Apellidos` LIKE '%$apellido%' ORDER BY `Nombre` ASC ";
	...
	<form name='borra' action='Cliente_Borrar_02.php' method='POST'>
...
function show_form($errors=''){
	...
	$ordenar = array (	'`id` ASC' => 'ORDER RESULTS',
						...
						'`Apellidos` ASC' => 'APELLIDOS A-Z',
						'`Apellidos` DESC' => 'APELLIDOS Z-A',
																);
...
function ver_todo(){
	...
	if(!$qb){
			...
			print (	"<tr align='center'>
				...
				<form name='modifica' action='Cliente_Borrar_02.php' method='POST'>
...
function accion_Borrar_01(){
	...
	global $text;
	$text = "- CLIENTE BORRAR 1 ".$ActionTime.". ".$nombre." ".$apellido;
