...
function process_form(){
	...
	$tabla = "<table align='center'>
				...
				<tr>
					<th colspan=3 class='BorderInf'>
						<form name='boton' action='Feedback_Cliente_Ver.php' method='post' >
	...
	$sql = "DELETE FROM `$db_name`.$gst_clientesfeedback WHERE $gst_clientesfeedback.`id` = '$_POST[id]' LIMIT 1 ";
