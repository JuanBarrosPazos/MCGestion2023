...
function process_form(){
	...
	if(!$qc){
			...
			print (	"<tr align='center'>
				...
				<form name='modifica' action='Feedback_Cliente_Recuperar_02.php' method='POST'>
		...
		<input name='Tlf2' type='hidden' value='".$rowc['Tlf2']."' />".$rowc['Tlf2']."
					...
					<tr>
						...
						<td colspan=2 align='center' class='BorderInf'>
												<input type='submit' value='RECUPERA CLIENTE' />
...
function show_form($errors=''){
	...
	print ("	
				...
				<tr>
					<td align='center'>
						<input type='submit' value='TODOS FEEDBACK CLIENTE' />
...
function accion_Feedback_Admin_01(){
	...
	elseif (($_SESSION['Nivel'] == 'user') || ($_SESSION['Nivel'] == 'caja')){ $dir = 'User';}
		...
		global $text;
		$text = "- CLIENTE FEEDBACK RECUPERAR 1 ".$ActionTime.". ".$nombre." ".$apellido;
