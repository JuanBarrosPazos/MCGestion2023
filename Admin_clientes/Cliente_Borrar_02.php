...
function process_form(){
	...
	$tabla = "<table align='center'>
				...
				<tr>
					<th colspan=3 class='BorderInf'>
						<form name='boton' action='Cliente_Ver.php' method='post' >
								<input type='submit' value='INCIO ADMINISTRADORES' />
	...
	$sql = "DELETE FROM `$db_name`.$gst_clientes WHERE $gst_clientes.`id` = '$_POST[id]' LIMIT 1 ";
