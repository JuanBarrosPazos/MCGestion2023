...
/**************************************/
	...
	$sqlc2 = "DELETE FROM `$db_name`.`clientesfeedback` WHERE `clientesfeedback`.`ID` = '$_POST[ID]' LIMIT 1 ";

	if(mysqli_query($db, $sqlc2)){
			print("HA BORRADO FEEDBACK CLIENTE");
				} else {
				print("<font color='#FF0000'>
	...
	.$defaults['visitadmin']."</br>
				...
				<tr height=40px>
					<td colspan='2' align='right'>
						<input type='submit' value='RECUPERAR CLIENTE' />
...
global $text;
$text = "- CLIENTE FEEDBACK RECUPERAR 2 ".$ActionTime.". ".$nombre." ".$apellido.".\n\t Ref: ".$rf.". Nivel: ".$_POST['Nivel'].".\n\t User: ".$_POST['Usuario'].". Pass: ".$_POST['Password'];
