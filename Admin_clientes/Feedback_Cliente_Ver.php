...
<form name='ver' action='Feedback_Cliente_Ver_02.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=500px,height=610px')\">
	...
	if(!$qb){
			...
			if(mysqli_num_rows($qb)== 0){
							print ("<table align='center'>
									...
									<tr>
										<th colspan=11 class='BorderInf'>
									TODOS LOS CLIENTES : ".mysqli_num_rows($qb)." Resultados.
										</th>
									</tr>
...
function accion_Feedback_01(){
	...
	global $text;
	$text = "- CLIENTE FEEDBACK VER ".$ActionTime.". ".$nombre." ".$apellido;
