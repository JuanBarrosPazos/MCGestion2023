...
function process_form(){
	...
	$sqlc =  "SELECT * FROM $gst_proveedores WHERE `ref` = '$ref' OR `dni` = '$dni' OR `rsocial` LIKE '$rso' ORDER BY $orden ";
	...
	if(!$qc){
		...
		<form name='modifica' action='Provee_Modificar_02.php' method='POST'>
...
function ver_todo(){
	...
	require "../config/TablesNames.php";
	$sqlb =  "SELECT * FROM $gst_proveedores ORDER BY $orden ";
...
function accion_Ver_01(){
	...
	global $text;
	$text = "- PROVEEDORES MODIF 01 ".$ActionTime.". ".$nombre." ".$apellido;
