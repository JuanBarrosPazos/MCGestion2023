...
function process_form(){
	...
	$sqlc =  "SELECT * FROM $gst_proveedoresfeed WHERE `ref` = '$ref' OR `dni` = '$dni' OR `rsocial` LIKE '$rso' ORDER BY $orden ";
	...
	if(!$qc){
			...
			if(mysqli_num_rows($qc)== 0){
							...
							print ("<table align='center'>
									...
									PROVEEDORES FEED : ".mysqli_num_rows($qc).".
										</th>
									</tr>
		...
		<form name='modifica' action='Provee_Modificar_Feed_02.php' method='POST'>
	...
	<form name='modifica_img' action='Provee_Modificar_img.php' target='popup' method='POST' onsubmit=\"window.open('', 'popup', 'width=520px,height=560px')\">
...
function show_form($errors=[]){
	...
	<form name='todo' method='post' action='$_SERVER[PHP_SELF]' >
				...
				<tr>
					<td align='center'>
						<input type='submit' value='TODOS LOS PROVEEDORES FEED' />
...
function ver_todo(){
	...
	require "../config/TablesNames.php";
	$sqlb =  "SELECT * FROM $gst_proveedoresfeed ORDER BY $orden ";
...
print("<font color='#FF0000'>Se ha producido un error: </font></br>".mysqli_error($db)."</br>");
			...
			if(mysqli_num_rows($qb)== 0){
							...
							print ("<table align='center'>
									<tr>
										<th colspan=8 class='BorderInf'>
									PROVEEDORES FEED ".mysqli_num_rows($qb).".
										</th>
									</tr>
...
function accion_Ver_01(){
	...
	global $text;
	$text = "- PROVEEDORES FEED MODIF 01 ".$ActionTime.". ".$nombre." ".$apellido;
