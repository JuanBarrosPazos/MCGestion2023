	...
	if(!$qc){
			...
			if(mysqli_num_rows($qc)== 0){
							...
							print ("<table align='center'>
									...
									BORRAR PROVEEDORES FEED : ".mysqli_num_rows($qc).".
										</th>
									</tr>
		...
		<input name='Tlf2' type='hidden' value='".$rowc['Tlf2']."' />
			...
			<td colspan=2 align='center' class='BorderInf'>
								<input type='submit' value='BORRAR FEED DATOS' />
...
print("<font color='#FF0000'>Se ha producido un error: </font></br>".mysqli_error($db)."</br>");
			...
			if(mysqli_num_rows($qb)== 0){
							...
							print ("<table align='center'>
									<tr>
										<th colspan=7 class='BorderInf'>
									BORRAR PROVEEDORES FEED".mysqli_num_rows($qb).".
										</th>
									</tr>
...
function accion_Ver_01(){
	...
	global $text;
	$text = "- PROVEEDORES FEED BORRAR 01 ".$ActionTime.". ".$nombre." ".$apellido;
