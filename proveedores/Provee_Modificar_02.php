...
function process_form(){
	...
	require "../config/TablesNames.php";
	$sqldni =  "SELECT * FROM `$db_name`.$gst_proveedores WHERE `gst_proveedores`.`dni` = '$_POST[dni]'";
...
//	print($_SESSION['dniold']);
	...
	$sql = "UPDATE `$db_name`.$gst_proveedores SET `ref` = '$rf', `rsocial` = '$_POST[rsocial]', `ldni` = '$_POST[ldni]', `Email` = '$_POST[Email]', `Direccion` = '$_POST[Direccion]', `Tlf1` = '$_POST[Tlf1]', `Tlf2` = '$_POST[Tlf2]' WHERE $gst_proveedores.`id` = '$_POST[id]' LIMIT 1 ";

	$sqf = "UPDATE `$db_name`.$gst_proveedoresfeed SET `ref` = '$rf', `rsocial` = '$_POST[rsocial]',  `ldni` = '$_POST[ldni]', `Email` = '$_POST[Email]', `Direccion` = '$_POST[Direccion]', `Tlf1` = '$_POST[Tlf1]', `Tlf2` = '$_POST[Tlf2]' WHERE $gst_proveedoresfeed.`dni` LIKE '$dniold' LIMIT 1 ";
		
	global $dnif;
	$dnif = $_POST['dni'].$_POST['ldni'];

	$sg1 = "UPDATE `$db_name`.$gst_gastos2 SET `refprovee` = '$rf', `factnif` = '$factnif', `factnom` = '$_POST[rsocial]' WHERE $gst_gastos2.`factnif` LIKE '$dnif' ";

	$sg2 = "UPDATE `$db_name`.$gst_gastos3 SET `refprovee` = '$rf', `factnif` = '$factnif', `factnom` = '$_POST[rsocial]' WHERE $gst_gastos3.`factnif` LIKE '$dnif' ";

	} else {

	require "../config/TablesNames.php";

	$sql = "UPDATE `$db_name`.$gst_proveedores SET  `ref`= '$rf', `rsocial` = '$_POST[rsocial]', `doc` = '$_POST[doc]', `dni` = '$_POST[dni]', `ldni` = '$_POST[ldni]', `Email` = '$_POST[Email]', `Direccion` = '$_POST[Direccion]', `Tlf1` = '$_POST[Tlf1]', `Tlf2` = '$_POST[Tlf2]' WHERE $gst_proveedores.`id` = '$_POST[id]' LIMIT 1 ";

	$sqf = "UPDATE `$db_name`.$gst_proveedoresfeed SET  `ref`= '$rf', `rsocial` = '$_POST[rsocial]', `doc` = '$_POST[doc]', `dni` = '$_POST[dni]', `ldni` = '$_POST[ldni]', `Email` = '$_POST[Email]', `Direccion` = '$_POST[Direccion]', `Tlf1` = '$_POST[Tlf1]', `Tlf2` = '$_POST[Tlf2]' WHERE $gst_proveedoresfeed.`dni` LIKE '$dniold' LIMIT 1 ";
	...
	//	$fil = "%".$rf."%";
	require "../config/TablesNames.php";
	$pimg =  "SELECT * FROM `$db_name`.$gst_proveedores WHERE `ref` = '$rf' ";
